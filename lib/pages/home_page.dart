...
class _HomePageState extends State<HomePage> {
  ...
  GroupBy _selectedGroupBy = GroupBy.exercise;
  ...
  Future<void> _fetchWorkoutData() async {
    ...
    try {
      ...
      print('Ошибка при получении данных о тренировке: $e');
      setState(() {
        _isLoading = false;
        _error = 'Не удалось загрузить данные тренировки. Пожалуйста, попробуйте снова.';
      });
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Домашняя страница', style: TextStyle(color: theme.colorScheme.onPrimary)),
